...
pcdshub/lcls-plc-xrt-optics: xrt_optics
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. list-table:: pcdshub/lcls-plc-xrt-optics: xrt_optics
    :header-rows: 1
...
pcdshub/lcls_plc_kfe_gatt: plc_kfe_gatt
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. list-table:: pcdshub/lcls_plc_kfe_gatt: plc_kfe_gatt
    :header-rows: 1
