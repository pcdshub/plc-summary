...
add_submodule lcls-plc-cxi-sample-delivery
add_submodule lcls-plc-cxi-usr-motion
#add_submodule lcls-plc-dev-pmps-subsystem
#add_submodule lcls-plc-dev-tfi
add_submodule lcls-plc-dream-motion
add_submodule lcls-plc-dream-vac
add_submodule lcls-plc-e727-motion
...
#add_submodule lcls-plc-fe-tst
add_submodule lcls-plc-ftl-leak-det
add_submodule lcls-plc-hxr-gon
add_submodule lcls-plc-hxr-polycap
add_submodule lcls-plc-hxr-vhs
add_submodule lcls-plc-hxx-vonhamos
add_submodule lcls-plc-icl-sample-delivery
...
add_submodule lcls-plc-lodcm-fat
add_submodule lcls-plc-lps-02
#add_submodule lcls-plc-marbox-test-project
add_submodule lcls-plc-mec-be-lens-interlock
add_submodule lcls-plc-mec-motion
add_submodule lcls-plc-mfx-be-lens-interlock
add_submodule lcls-plc-mfx-bsm
add_submodule lcls-plc-mfx-motion
add_submodule lcls-plc-mfx-sample-delivery
add_submodule lcls-plc-mfx-vac
add_submodule lcls-plc-mfx-vac-backup
add_submodule lcls-plc-mini-powermeter-calib
add_submodule lcls-plc-motion-abstraction-sample
#add_submodule lcls-plc-motion-test-stand
add_submodule lcls-plc-mrco-motion
add_submodule lcls-plc-mrco-vac
#add_submodule lcls-plc-neh-tst
add_submodule lcls-plc-polycapillary
add_submodule lcls-plc-qrix-motion
add_submodule lcls-plc-qrix-vac
add_submodule lcls-plc-rix-sample-delivery
add_submodule lcls-plc-rix-sds-injector
add_submodule lcls-plc-rixs-optics
add_submodule lcls-plc-rixs-svls-motion
add_submodule lcls-plc-rix-xpfs
add_submodule lcls-plc-roving-spectrometer
add_submodule lcls-plc-sample-delivery-system
#add_submodule lcls-plc-sds-vis
add_submodule lcls-plc-smartactmcs2-motion
add_submodule lcls-plc-sxr-satt
#add_submodule lcls-plc-template-twincat-project
#add_submodule lcls-plc-template-twincat-vacuum
#add_submodule lcls-plc-template-user-motors
...
#add_submodule lcls-plc-test-lodcm
...
#add_submodule lcls-plc-test-surestop-limit-switches
add_submodule lcls-plc-tmo-mbes-motion
add_submodule lcls-plc-tmo-mbes-vac
...
#add_submodule lcls-plc-tst-ioc
add_submodule lcls-plc-txi-dccm
...
add_submodule lcls-plc-txi-sxr-motion
add_submodule lcls-plc-txi-sxr-vac
add_submodule lcls-plc-ued-sample-delivery
add_submodule lcls-plc-vhs-01
add_submodule lcls-plc-vls-vac
add_submodule lcls-plc-xcs-fpms
add_submodule lcls-plc-xcs-liquid-jet
add_submodule lcls-plc-xcs-per-vac
add_submodule lcls-plc-xcs-sample-delivery
add_submodule lcls-plc-xpp-atds
add_submodule lcls-plc-xpp-granite-mot
add_submodule lcls-plc-xpp-jjslit-motion
add_submodule lcls-plc-xpp-lodcm
add_submodule lcls-plc-xpp-motion
add_submodule lcls-plc-xpp-pulsepicker-motion
add_submodule lcls-plc-xpp-tfs
add_submodule lcls-plc-xpp-vac
add_submodule lcls-plc-xrt-optics
add_submodule lcls-plc-xrt-vacuum


# Supporting modules:
SUPPORT=./support
#add_submodule lcls-twincat-ci-test "${SUPPORT}"
add_submodule lcls-twincat-common-components "${SUPPORT}"
add_submodule lcls-twincat-device-abstraction "${SUPPORT}"
add_submodule lcls-twincat-general "${SUPPORT}"
add_submodule lcls-twincat-he-satt "${SUPPORT}"
add_submodule lcls-twincat-math "${SUPPORT}"
add_submodule lcls-twincat-motion "${SUPPORT}"
add_submodule lcls-twincat-motion-abstraction "${SUPPORT}"
add_submodule lcls-twincat-motion-synchronous "${SUPPORT}"
#add_submodule lcls-twincat-motion-synchronous-validation "${SUPPORT}"
...
add_submodule lcls-twincat-rail "${SUPPORT}"
add_submodule lcls-twincat-review "${SUPPORT}"
add_submodule lcls-twincat-sample-delivery "${SUPPORT}"
add_submodule lcls-twincat-telemetry "${SUPPORT}"
add_submodule lcls-twincat-vacuum "${SUPPORT}"
#add_submodule lcls-twincat-vacuum-old "${SUPPORT}"
